...
describe('Percy Visual Test for Single Blog', () => {
    ...
    const pagesToTest = [
        { name: '20 Best Minimum Viable Product Examples: What Iconic Brands and Newcomers Taught Me About Product Success', url: 'https://appetiser.com.au/blog/minimum-viable-product-example/' }
    ];
        ...
        viewports.forEach((viewport) => {
            context(`Visual Test - ${page.name} - ${viewport.name} (${viewport.width}x${viewport.height})`, () => {
                ...
                beforeEach(() => {
                    ...
                    cy.wait(2000);
                    cy.get('.CampaignType--slide').invoke('css', 'opacity', '0');
