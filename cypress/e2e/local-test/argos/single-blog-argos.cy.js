describe('Argos Visual Test for Single Blog', () => {
    ...
    const pagesToTest = [
        { name: '35 Tech Startup Ideas That Sell in 2025', url: 'http://appetiser.local/blog/tech-startups-ideas/' },
        { name: '20 Best Minimum Viable Product Examples: What Iconic Brands and Newcomers Taught Me About Product Success', url: 'http://appetiser.local/blog/minimum-viable-product-example/' },
        { name: 'The Most Loved and Hated Programming Languages (With Developer’s Insights and Tips)', url: 'http://appetiser.local/blog/most-loved-programming-languages/' }
    ];
