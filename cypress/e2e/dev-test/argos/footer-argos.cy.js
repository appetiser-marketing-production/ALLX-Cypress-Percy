describe('Argos Visual Test for Footer ', () => {
    ...
    viewports.forEach((viewport) => {
        ...
        context(`Visual Test - Footer ${viewport.name} (${viewport.width}x${viewport.height})`, () => {
            ...
            beforeEach(() => {
                ...
                // Visit the Header
                cy.visit('https://dev.appetiser.com.au/', {
                    auth: {
                ...
                cy.scrollTo(0, 2298)
                cy.get('.infinite-fixed-navigation.infinite-style-slide').invoke('css', 'position', 'absolute')
            ...
            it(`Visual Test - Footer: ${viewport.name}`, () => {

                // --- Desktop Specific Tests ---
                if (viewport.name === 'Desktop') {
                    cy.get('footer').should('be.visible').wait(2000).argosScreenshot("Footer ", { viewports: [{ width: viewport.width, height: viewport.height }] })
                }
